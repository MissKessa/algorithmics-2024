...
public class ImageAveragerBench {
	...
	public static void main(String[] args) {
		...
		int n_real, n_bad;
		ImageAveragerBnB img_avger;

		// Generating and testing a single dataset instance
		n_bad = (int) ((PERCENTAGE_BAD / 100.) * N_IMGS);
		n_real = N_IMGS - n_bad;
		img_avger = new ImageAveragerBnB(REAL_IMG, BAD_IMG, n_real, n_bad, S_NOISE);
...
//		img_avger.saveResults(OUT_DIR_B);
//
//		System.out.print("TESTING BRANCH AND BOUNDS:\n");
//		img_avger.splitSubsetsBnB(N_IMGS);
//		System.out.printf("  -ZNCC: %f\n",  img_avger.zncc());
//		System.out.printf("  -Counter: %d\n",  img_avger.getCounter());
//		img_avger.saveResults(OUT_DIR_B);
		...
		for (int n = 2; n <= 13; n++) {
			...
			img_avger.splitSubsetsBnB(n);
			t2 = System.currentTimeMillis();
			System.out.println("BnB   n=" + n + "**TIME=" + (t2 - t1));
		}
//		for (int n = 2; n <= 13; n++) {
//			n_bad = (int) ((PERCENTAGE_BAD / 100.) * n);
//			n_real = n - n_bad;
