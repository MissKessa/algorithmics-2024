...
/**
 * GREEDY ALGORITHM PROBLEM: MAXIMIZE THE NUMBER OF FILES ON A DISK It has an
 * optimal solution. The idea is: First the smallest files while the disc has
 * enough space to copy them
 * 
 * @author viceg
 *
 */
public class FilesDisc1 {
	...
	public int calculate() { // O(n)
		...
		int counter = 0;
		int numberOfFiles = 0;
		while (i < files.length) { // until I finish
