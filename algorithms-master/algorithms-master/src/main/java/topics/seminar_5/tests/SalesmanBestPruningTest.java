...
import topics.seminar_5.SalesmanBestPruning;

public class SalesmanBestPruningTest {
	private static Logger log = LoggerFactory.getLogger(SalesmanBestPruningTest.class);
	private SalesmanBestPruning salesman;
	...
	public void testSalesman() {
		...
		salesman = new SalesmanBestPruning(n, source, w);
