...
import topics.seminar_5.SalesmanBest;

public class SalesmanBestTest {
	private static Logger log = LoggerFactory.getLogger(SalesmanBestTest.class);
	private SalesmanBest salesman;
	...
	public void testSalesman() {
		...
		salesman = new SalesmanBest(n, source, w);
